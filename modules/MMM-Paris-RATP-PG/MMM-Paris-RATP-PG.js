...
//          firstCell.className = "align-right bright";
          firstCell.className = "align-center";
	  ...
	  firstCell.className = "align-center";
          ...
          if (d.data && d.data.station_state == 'Operative') { //&&&
            secondCell.innerHTML = d.data['nbbike'] + '  <i id="line-' + i + '-velib" class="fa fa-bicycle' + '"></i>&nbsp&nbsp&nbsp';
            secondCell.innerHTML += d.data['nbebike'] + '  <i id="line-' + i + '-velib" class="fa fa-motorcycle' + '"></i>&nbsp&nbsp&nbsp';
            secondCell.innerHTML += d.data['nbfreeedock'] + '  <i id="line-' + i + '-velibDock" class="fa fa-unlock' + '"></i>&nbsp&nbsp&nbsp';
          } else {
            secondCell.innerHTML = '<i id="line-' + i + '-velib" class="fa fa-window-close' + '"></i>&nbsp&nbsp&nbsp';
          }
          row.appendChild(secondCell);
          table.appendChild(row);
          if (l.velibGraph) {
